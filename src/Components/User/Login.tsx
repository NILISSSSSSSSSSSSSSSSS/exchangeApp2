      ...
      this.state.loginStep === 0?
        (<div className="login">
          ...
          <div className="link" style={{position: 'fixed', bottom: 20, textAlign: 'left'}}>
            {/* <div onClick={() => this.props.setPageHandle('reset')}>忘记密码</div> */}
            <div style={{marginTop: 20}}><span className="font-main">还没有账号？</span> <span onClick={() => this.props.setPageHandle('register')}>注册</span></div>
          </div>
        </div>):
        (
